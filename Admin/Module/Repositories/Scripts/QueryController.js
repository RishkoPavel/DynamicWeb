    ...
    $scope.updateDataModel = function () {
        ...
        if (calledFrom == "PIM") {
            queryRepository.getListViewFields(function (results) {
                ...
                addDefaultFields($scope.query, 'ListViewFields');

                var compareListFields = function (viewField, field) {
                    return viewField.Source == field._systemName;
                };

                var createListFieldItem = function (field, sortIndex) {
                    return { Name: field._name, Value: field._systemName, Sort: sortIndex || field._sort };
                };
