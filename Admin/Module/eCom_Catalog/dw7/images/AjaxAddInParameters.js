...
function getParameters_callback(xhttp, divname) {
    ...
    if (xhttp.readyState == 4) {
        ...
        if (xhttp.status == 200) {
            ...
            toggleHideParameters(parameters);
...
function toggleHideParameters(parametersDiv) {
    var dropdowns = findParametersByAttributeContainsValue(parametersDiv, "onchange", "hideParameters(", "select");
    if (dropdowns !== null) {
