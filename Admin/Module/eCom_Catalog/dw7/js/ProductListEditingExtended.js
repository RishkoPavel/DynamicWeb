...
Dynamicweb.PIM.BulkEdit.prototype.handleScrollAndFocus = function () {
    ...
    var fieldInViewport = function (elem) {
        let containerLocation = $("listContainer").getBoundingClientRect();
        let elementLocation = elem.getBoundingClientRect();
...
Dynamicweb.PIM.BulkEdit.prototype.openProduct = function ({ productId, variantId = "", queryId, groupId, scrollToVariant = false, scrollToField = false, fieldControlIdToScroll, listPageIds = null }) {
    var self = this;
