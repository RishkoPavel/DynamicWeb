...
<updates>
    ...
    <current version="2183" releasedate="15-09-2020" />
    
    <package version="2183" releasedate="15-09-2020">
    ...
    <package version="2175" releasedate="09-06-2020">
        <database file="Ecom.mdb">
            <EcomDetailGroupValues>
				<sql conditional="">
                    ALTER TABLE [EcomDetailGroupValues] DROP [GroupDetailIsDefault]
				</sql>
            </EcomDetailGroupValues>
        </database>
    </package>
    ...
    <package version="2173" releasedate="06-06-2020">
        <database file="Ecom.mdb">
            <EcomDetailGroupValues>
                <sql conditional="SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME='EcomDetailGroupValues'">
                    CREATE TABLE [EcomDetailGroupValues](
	                    [GroupDetailId] [nvarchar](255) NOT NULL,
	                    [GroupDetailGroupId] [nvarchar](30) NULL,
	                    [GroupDetailLanguageId] [nvarchar](50) NULL,
	                    [GroupDetailType] [smallint] NULL DEFAULT 0,
	                    [GroupDetailValue] [nvarchar](max) NULL,
	                    [GroupDetailSortOrder] [int] NULL,
	                    [GroupDetailAutoId] [int] IDENTITY(1,1) NOT NULL,
	                    [GroupDetailIsDefault] [bit] NOT NULL DEFAULT 0,
	                    [GroupDetailAssetGroupId] [int] NULL,
                        CONSTRAINT [DW_PK_EcomDetailGroupValues] PRIMARY KEY NONCLUSTERED ([GroupDetailId] ASC)
                    )
                </sql>
            </EcomDetailGroupValues>
        </database>
    ...
    <package version="2166" date="14-05-2020">
        ...
        <file name="InformationInlineForm.cshtml" source="/Files/Templates/Designs/Dynamicweb/eCom7/CartV2/Step/" target="/Files/Templates/Designs/Dynamicweb/eCom7/CartV2/Step/" overwrite="false"/>
    </package>
